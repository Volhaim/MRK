					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<dl>
								...
								<dd>
									<?php
									  if($stat[$status] =='На рассмотрении'){
									  	echo "<span class='badge badge-secondary'>{$stat[$status]}</span>";
									  }elseif($stat[$status] =='Начат'){
								...
								<tr>
			                        ...
			                        <td class="text-center">
					                    ...
					                    <div class="dropdown-menu" style="">
					                      ...
					                      <?php if($_SESSION['login_type'] != 3): ?>
					                      <a class="dropdown-item edit_task" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"  data-task="<?php echo $row['task'] ?>">Редактирование</a>
					                      <div class="dropdown-divider"></div>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Комментарии</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Новый комментарий</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
						...
						<div class="post">
		                      ...
		                      <div class="user-block">
								  ...
								  <div class="dropdown-menu">
								  	<a class="dropdown-item manage_progress" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"  data-task="<?php echo $row['task'] ?>">Редактирование</a>
			                      	<div class="dropdown-divider"></div>
		                        ...
		                        <span class="description">
		                        	...
		                        	<span class="fa fa-user-clock"></span>
                      				<span>Начало: <b><?php echo date('h:i A',strtotime($row['date'].' '.$row['start_time'])) ?></b></span>
		                        	<span> | </span>
                      				<span>Конец: <b><?php echo date('h:i A',strtotime($row['date'].' '.$row['end_time'])) ?></b></span>
	                        	</span>
