			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Работник</option>
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Исполнитель</option>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="label control-label">Подтвердите пароль</label>
